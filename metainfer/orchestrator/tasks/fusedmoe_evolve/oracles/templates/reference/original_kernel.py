"""
Frozen reference copy of the original fused_moe_kernel from SGLang.

This file is NEVER modified. It serves as:
1. Correctness reference for the evaluator
2. Performance baseline for speedup calculation

Source: sglang-v0.5.10_dpsk_v4/python/sglang/srt/layers/moe/fused_moe_triton/fused_moe_triton_kernels.py
Lines: 86-103 (write_zeros_to_output), 338-626 (fused_moe_kernel), 842-844 (tanh)
"""
...
def get_reference_kernel():
    """Return the reference fused_moe_kernel function."""
    return fused_moe_kernel


if __name__ == "__main__":
    print("Reference kernel loaded successfully.")
    print(f"  fused_moe_kernel: {fused_moe_kernel}")
    print(f"  write_zeros_to_output: {write_zeros_to_output}")
    print(f"  tanh: {tanh}")
