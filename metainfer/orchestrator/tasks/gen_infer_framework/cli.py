...
Direct CLI usage (for debugging without the WebUI):
    ...
    python -m metainfer.orchestrator.gen_infer_framework.cli run requirements.json
    python -m metainfer.orchestrator.gen_infer_framework.cli run requirements.json --state-dir /path/to/task
"""
